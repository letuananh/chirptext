...
class TestSino(unittest.TestCase):
    ...
    def test_sino(self):
        ...
        黃 = rads['黃']
        黃_json = {'idseq': '201', 'radical': '黃', 'variants': '', 'strokes': '12', 'meaning': 'yellow', 'pinyin': 'huáng', 'hanviet': 'hoàng', 'hiragana': 'きいろ ', 'romaji': ' kiiro', 'hangeul': '누를황 ', 'romaja': ' nureulhwang', 'frequency': '42', 'simplified': '', 'examples': '黈 䵍 黌'}
        self.assertEqual(黃.to_json(), 黃_json)
